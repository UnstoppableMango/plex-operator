...
# unmango.dev/plex-operator-bundle:$VERSION and unmango.dev/plex-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= unmango.dev/plex-operator
...
ifeq (,$(shell which helm-operator 2>/dev/null))
	...
	curl -sSLo $(HELM_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/unknown/helm-operator_$(OS)_$(ARCH) ;\
