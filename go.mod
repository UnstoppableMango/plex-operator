module github.com/unstoppablemango/plex-operator

go 1.24.3

tool github.com/operator-framework/operator-sdk/cmd/operator-sdk
...
require (
	...
	github.com/operator-framework/ansible-operator-plugins v1.37.2 // indirect
	...
	github.com/operator-framework/operator-sdk v1.39.2 // indirect
	...
	k8s.io/kubectl v0.31.7 // indirect
	...
	sigs.k8s.io/kubebuilder/v4 v4.2.0 // indirect
